...
public class PrivilegeDao_Test {
	...
	public void selectPrivilegeByIdTest() {
		//retrieving id by pre-inserted admin id of '1'
	...
	public void insertPrivilegeTest() {
		//creating new Privilege object, and storing id of newly inserted priv object
		...
		//since no method can retrieve newly inserted priv due to sequence unknown
		//we remove priv here as we cant know id to remove in a AfterClass.
